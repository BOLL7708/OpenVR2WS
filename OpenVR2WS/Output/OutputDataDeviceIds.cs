...
[ExportTsInterface]
public class OutputDataDeviceIds(Dictionary<ETrackedDeviceClass, HashSet<uint>> deviceToIndex, Dictionary<EasyOpenVRSingleton.InputSource, int> sourceToIndex)
{
